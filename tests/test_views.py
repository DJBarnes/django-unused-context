...
class DumpDieViewSimpleTestCase(TestCase):
    ...
    def test_using_some_context_vars_raises_warnings_about_unused_context(self):
        ...
        warning_message = "Request Context <WSGIRequest: GET '/some_context'> had unused keys:"
    ...
    def test_using_no_context_vars_ignores_ones_set_by_ignore_setting_when_raising_warnings(self):
    ...
    def test_using_no_context_vars_does_not_raise_warnings_about_unused_context_when_debug_is_false(self):
